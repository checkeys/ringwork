...
def create_app(access_control: Optional[AccessControl] = None) -> App:
    if access_control is None:
        access_control = AccessControl.from_file()
...
def run_as_web_server(host: str = "0.0.0.0", port: int = 8000, quiet: bool = True) -> None:  # noqa:E501
    access_control: AccessControl = AccessControl.from_file()
    public_key_api: PublicKeyAPI = PublicKeyAPI(access_control.users)
